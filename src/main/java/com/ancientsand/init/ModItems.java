...
public class ModItems {
    ...
    public static RegistryObject<Item> ANCIENT_SWORD = register(() -> new StrongSwordItem(ModTiers.ANCIENT, 3, -2.4f, new Item.Properties()), "ancient_sword");
    public static RegistryObject<Item> ANCIENT_DAGGER = register(() -> new DaggerItem(ModTiers.DAGGER, 0, 1f, new Item.Properties()), "ancient_dagger");
    ...
    public static RegistryObject<Item> LYRE = register(() -> new LyreItem(new Item.Properties()), "lyre");

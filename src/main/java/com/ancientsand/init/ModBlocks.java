...
public class ModBlocks {
    ...
    public static RegistryObject<Block> REMNANT_STAIRS = register(() -> new StairBlock(REMNANT_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.copy(REMNANT_BLOCK.get())), "remnant_stairs");
    public static RegistryObject<Block> REMNANT_SLAB = register(() -> new SlabBlock(BlockBehaviour.Properties.copy(REMNANT_BLOCK.get())), "remnant_slab");
    public static RegistryObject<Block> ANCIENT_BLOCK = register(() -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)), "ancient_block");
    ...
    public static RegistryObject<Block> ROYAL_CHAMBER = register(() -> new ChamberBlock(BlockBehaviour.Properties.copy(COMMON_CHAMBER.get()), ModLootTables.CHAMBER_ROYAL_LOOT, true), "royal_chamber");
    public static RegistryObject<Block> ROYAL_CARPET = register(() -> new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.RED_CARPET)), "royal_carpet");

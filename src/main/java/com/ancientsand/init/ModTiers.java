...
public enum ModTiers implements Tier {
    ANCIENT(BlockTags.INCORRECT_FOR_IRON_TOOL, 202, 6.0F, 2.0F, 6, () -> Ingredient.of(ModItems.ANCIENT_INGOT.get())),
    DAGGER(BlockTags.INCORRECT_FOR_IRON_TOOL, 202, 2.0F, 2.0F, 6,() -> Ingredient.of(ModItems.ANCIENT_INGOT.get()));

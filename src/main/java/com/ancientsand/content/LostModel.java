...
@OnlyIn(Dist.CLIENT)
public class LostModel<T extends Mob & RangedAttackMob> extends HumanoidModel<T> {
    public LostModel(ModelPart p_170941_) {
        super(p_170941_);
    }
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F), PartPose.offset(0.0F, 0.0F, 0.0F))
                .addOrReplaceChild("beard", CubeListBuilder.create().texOffs(48, 16).addBox(-1.0F, 1.5F, -3.2F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));
